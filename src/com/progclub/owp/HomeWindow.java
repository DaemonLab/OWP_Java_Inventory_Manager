...
public class HomeWindow extends JFrame implements ActionListener
{
	...
	public HomeWindow()
	{
		...
		this.addWindowListener(new WindowListener() {
			...
			{
				// When window is being closed, properly close the connection to the database
				DatabaseHelper.closeConnection();
			}
			// We don't need these but must override these
			@Override
		...
		gbl_contentPane.columnWeights = new double[]{1};
